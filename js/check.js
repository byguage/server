...
function executeMinecraftLink(event) {
    ...
    function shouldExecuteMinecraftLink(event) {
        ...
        if ((ua.indexOf('QQ/') !== -1 || ua.indexOf(' qq') > -1 && ua.indexOf('mqqbrowser') < 0 || ua.match(/QQ/i) == "qq" && ua.indexOf('qqtheme') > -1 || u.toLowerCase().indexOf('micromessenger') !== -1 || ua.indexOf('MicroMessenger') !== -1) && conf.qqjump === 1) {
